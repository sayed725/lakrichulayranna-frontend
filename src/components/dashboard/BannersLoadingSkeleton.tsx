          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0 flex-1">
                <div className="w-20 h-12 sm:w-24 sm:h-14 bg-cream-dark/50 dark:bg-white/10 animate-pulse rounded-xl shrink-0" />
            ...
            <div className="flex items-center justify-between border-t border-border/50 dark:border-white/5 pt-2.5">
              <div className="h-5 w-20 bg-cream-dark/40 dark:bg-white/10 animate-pulse rounded-full" />
