    ...
    <>
      ...
      <div className="lg:hidden space-y-3.5">
        {[...Array(6)].map((_, i) => (
          ...
          >
            {/* Header: Person Avatar, Name & Actions */}
            ...
            {/* Subject & Message Box */}
            <div className="bg-cream/30 dark:bg-charcoal-light/20 p-2.5 rounded-xl border border-border/40 space-y-1.5">
              <div className="h-4 w-3/4 bg-cream-dark/40 dark:bg-white/10 animate-pulse rounded" />
              <div className="h-8 w-full bg-cream-dark/30 dark:bg-white/5 animate-pulse rounded" />
            </div>

            {/* Status Footer */}
            <div className="flex items-center justify-between pt-1 border-t border-border/50">
              <div className="h-3.5 w-16 bg-cream-dark/40 dark:bg-white/10 animate-pulse rounded" />
              <div className="h-6 w-20 bg-cream-dark/40 dark:bg-white/10 animate-pulse rounded-full" />
            </div>
          </div>
        ))}
      </div>
