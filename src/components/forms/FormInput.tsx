    ...
    return (
      <div className="w-full">
        ...
        <input
          ref={ref}
          className={cn(
            "w-full px-4 py-3 rounded-xl border bg-cream/50 text-charcoal font-bengali text-sm outline-none transition-all duration-200 placeholder:text-muted-light",
            error
