    ...
    <div className="min-h-screen bg-cream-dark/20 py-12 px-4">
      <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="space-y-3 font-bengali text-sm">
              <p className="flex items-center gap-2">
                ...
                <span className="font-semibold text-charcoal">
                  {order.customerName || parsedAddress.fullName || 'N/A'}
                </span>
              </p>
              <p className="flex items-center gap-2">
                <Phone size={16} className="text-muted" />
                <span className="font-latin text-charcoal">
                  {order.customerPhone || parsedAddress.phone || 'N/A'}
                </span>
              </p>
        ...
        <div className="text-center">
          <Link 
            href="/my-orders"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-cream-dark text-charcoal rounded-xl font-bold font-bengali hover:bg-cream-dark/80 transition-all cursor-pointer"
          >
            <ArrowLeft size={18} />
            আমার অর্ডারে যান
          </Link>
