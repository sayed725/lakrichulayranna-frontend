...
interface ProductsClientProps {
  ...
  initialItemsData: any;
  urlCategoryName: string;
  urlIsSpicy: boolean;
  urlIsFeatured: boolean;
  urlMinPrice: string;
  urlMaxPrice: string;
}
        ...
        <div className="flex flex-col lg:flex-row gap-3">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-4">
            ...
            <Button
              ...
              className="flex items-center gap-2 px-4 py-2.5 h-auto bg-white rounded-xl border border-border text-charcoal font-semibold font-bengali hover:bg-fire hover:text-white transition-colors shrink-0"
            >
              <Filter size={18} />
              ফিল্টার
            </Button>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  {hasActiveFilters && (
                    <Button
                      ...
                      className="text-xs text-fire hover:text-fire-dark font-semibold transition-colors h-auto w-auto p-0 hover:bg-transparent"
                    >
                      রিসেট
                    </Button>
                  )}
              ...
              <div className="bg-white rounded-2xl border border-border p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className={`relative w-12 h-6 p-0 rounded-full transition-colors border-0 outline-none hover:!text-inherit ${
                      isSpicy ? "bg-fire hover:!bg-fire" : "bg-charcoal/20 hover:!bg-charcoal/20"
                    }`}
                  >
                    <span
              ...
              <div className="bg-white rounded-2xl border border-border p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className={`relative w-12 h-6 p-0 rounded-full transition-colors border-0 outline-none hover:!text-inherit ${
                      isFeatured ? "bg-fire hover:!bg-fire" : "bg-charcoal/20 hover:!bg-charcoal/20"
                    }`}
                  >
                    <span
                      className={`absolute top-1 w-4 h-4 rounded-full bg-white transition-transform ${
            ...
            {items.length > 0 ? (
                ...
                {hasMore && (
                  <div className="text-center pt-4">
                    <Button
                      ...
                      className="px-6 py-2.5 h-auto bg-fire text-white rounded-xl font-bold font-bengali hover:bg-fire-dark transition-all cursor-pointer shadow-md disabled:opacity-75 disabled:cursor-not-allowed min-w-[140px] flex items-center justify-center gap-2 mx-auto border-0"
                    >
              ...
              <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border border-border border-dashed text-center">
                ...
                <Button
                  ...
                  className="mt-6 px-6 py-2.5 h-auto bg-fire/10 text-fire rounded-xl font-semibold font-bengali hover:bg-fire hover:text-white transition-colors cursor-pointer border-0"
                >
                  সব খাবার দেখুন
                </Button>
              </div>
